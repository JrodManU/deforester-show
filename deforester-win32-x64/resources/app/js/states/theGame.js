...
theGame.prototype = {
	...
	create: function() {
		...
		this.spaceBackground = this.game.add.tileSprite(0,0,1152,648,'spaceBackground');
		this.spaceBackground.fixedToCamera = true;
		...
		this.game.playerManager.questManager.broadcastUpdate("visitedPlanets", 1);
		this.game.playerManager.visitedFirstPlanet = true;
		
		this.hud = new HUD(this.game);
		
		this.game.playerManager.planetSet.selectedPlanet.load(this);
		
		this.game.playerManager.tutorialManager.tryToCreateNewTutorial("Basic");
		
		this.createMultiUseEmitters();
	},
	update: function() {
		this.spaceBackground.tilePosition.x -= 0.5;
